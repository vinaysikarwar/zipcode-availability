...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('WebTechnologyCodes_ZipcodeAvailablity::Zipavail')
            ->addBreadcrumb(__('WebTechnologyCodes ZipcodeAvailablity'), __('WebTechnologyCodes ZipcodeAvailablity'))
